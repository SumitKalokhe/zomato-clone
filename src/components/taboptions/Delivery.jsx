...
import DeliveryCarousel from "./food-carousel/DeliveryCarousel";
...
const Delivery = () => {
    ...
    return (
        <div>
            ...
            <div >
                <DeliveryCarousel deliveryItem={deliveryItem} />
            </div>
            <div > <Explore list={restaurantList} heading='Delivery Restaurants in Nashik'/></div>
        </div>
    )
}
